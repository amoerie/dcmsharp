...
{
    public bool TryGetDecimals(DicomTag tag, out decimal[] values) =>
        TryGetDecimals(tag.Group, tag.Element, out values);

    public bool TryGetDecimals(ushort group, ushort element, out decimal[] values)
    {
