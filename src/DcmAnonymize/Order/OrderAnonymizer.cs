...
{
    private readonly ConcurrentDictionary<string, AnonymizedOrder> _anonymizedOrders =
        new ConcurrentDictionary<string, AnonymizedOrder>();
    ...
    public async Task AnonymizeAsync(DicomAnonymizationContext context)
    {
        ...
        var originalOrderName = dicomDataSet.GetSingleValueOrDefault(
